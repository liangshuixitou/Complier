...
{
       0,    60,    60,    63,    64,    67,    67,    68,    69,    70,
      71,    72,    75,    76,    79,    83,    86,    92,    93,    94,
      97,   100,   101,   103,   106,   107,   108,   109,   110,   111,
     112,   113,   114,   115,   118,   119,   120,   123,   123,   123,
     123,   123,   123,   126,   127,   129,   131
};
#endif
...
{
  "$end", "error", "$undefined", "TIDENTIFIER", "TNUMBER", "TINT",
  "TVOID", "TCEQ", "TCNE", "TCLT", "TCLE", "TCGT", "TCGE", "TEQUAL",
  "TLPAREN", "TRPAREN", "TLBRACK", "TRBRACK", "TLBRACE", "TRBRACE",
  "TCOMMA", "TDOT", "TSEMI", "TPLUS", "TMINUS", "TMUL", "TDIV", "TIF",
  "TELSE", "TFOR", "TRETURN", "TWHILE", "$accept", "program", "stmts",
  "stmt", "block", "var_decl", "func_decl", "func_decl_args", "ident",
  "typename", "numeric", "expr", "call_args", "comparison", "if_stmt",
...
{
      66,   -54,   -54,   -54,   -54,    44,    44,     6,    44,    13,
      29,    66,   -54,    28,   -54,     1,    51,   -54,    76,   -54,
     -54,   -54,    96,   105,    44,   125,    44,   -54,   -54,   -54,
      44,    44,    31,   -54,   -54,   -54,   -54,   -54,   -54,   -54,
      44,    44,    44,    44,    44,   -54,     3,    32,   131,   -54,
     151,   189,   189,    -4,    44,    47,   209,   209,   215,   215,
     189,   -54,    37,    43,    44,    43,   -54,    44,   189,   -54,
      -2,    51,   -54,   -54,   160,   -54,   189,    43,    47,    50,
      44,   -54,   -54,   180,    43,   -54
};
...
{
       0,    20,    23,    22,    21,     0,     0,     0,     0,     0,
       0,     2,     3,     0,     6,    26,     0,    27,     0,     9,
      10,    11,     0,     0,     0,     0,     0,     1,     4,     5,
       0,    34,    14,    37,    38,    39,    40,    41,    42,     7,
       0,     0,     0,     0,     0,    29,     0,    43,     0,     8,
       0,    24,    35,     0,     0,    17,    32,    33,    30,    31,
      28,    13,     0,     0,     0,     0,    25,     0,    15,    18,
       0,     0,    12,    44,     0,    46,    36,     0,     0,    14,
       0,    16,    19,     0,     0,    45
};
...
{
      -1,    10,    11,    12,    47,    13,    14,    70,    15,    16,
      17,    18,    53,    44,    19,    20,    21
};
...
{
      22,    23,    32,    25,    28,    69,     1,     2,     3,     4,
      73,    66,    75,    77,    30,    31,    67,     5,    78,    48,
      24,    50,    61,    71,    81,    51,    52,    26,    82,    27,
       6,    85,     7,     8,     9,    56,    57,    58,    59,    60,
       1,     2,     3,     4,    54,    55,    71,     1,     2,    68,
      29,     5,     3,     4,     1,    28,    72,    79,     5,    74,
      63,    46,    76,    54,     6,    62,     7,     8,     9,     1,
       2,     3,     4,     0,     0,    83,     0,     0,     0,     0,
       5,     0,     0,    33,    34,    35,    36,    37,    38,     0,
       0,     0,     0,     6,     0,     7,     8,     9,    39,    40,
      41,    42,    43,    33,    34,    35,    36,    37,    38,     0,
       0,    45,    33,    34,    35,    36,    37,    38,     0,    40,
      41,    42,    43,    46,     0,     0,     0,     0,    40,    41,
      42,    43,    33,    34,    35,    36,    37,    38,    33,    34,
      35,    36,    37,    38,     0,     0,     0,    49,    40,    41,
      42,    43,     0,    64,    40,    41,    42,    43,    33,    34,
      35,    36,    37,    38,     0,     0,    65,    33,    34,    35,
      36,    37,    38,     0,    40,    41,    42,    43,     0,     0,
       0,     0,    80,    40,    41,    42,    43,    33,    34,    35,
      36,    37,    38,     0,     0,    84,    33,    34,    35,    36,
      37,    38,     0,    40,    41,    42,    43,     0,     0,     0,
       0,     0,    40,    41,    42,    43,    33,    34,    35,    36,
...
{
       5,     6,    16,     8,    11,    55,     3,     4,     5,     6,
      63,    15,    65,    15,    13,    14,    20,    14,    20,    24,
      14,    26,    19,    55,    77,    30,    31,    14,    78,     0,
      27,    84,    29,    30,    31,    40,    41,    42,    43,    44,
       3,     4,     5,     6,    13,    14,    78,     3,     4,    54,
      22,    14,     5,     6,     3,    62,    19,    71,    14,    64,
      28,    18,    67,    13,    27,    46,    29,    30,    31,     3,
       4,     5,     6,    -1,    -1,    80,    -1,    -1,    -1,    -1,
      14,    -1,    -1,     7,     8,     9,    10,    11,    12,    -1,
      -1,    -1,    -1,    27,    -1,    29,    30,    31,    22,    23,
      24,    25,    26,     7,     8,     9,    10,    11,    12,    -1,
      -1,    15,     7,     8,     9,    10,    11,    12,    -1,    23,
      24,    25,    26,    18,    -1,    -1,    -1,    -1,    23,    24,
      25,    26,     7,     8,     9,    10,    11,    12,     7,     8,
       9,    10,    11,    12,    -1,    -1,    -1,    22,    23,    24,
      25,    26,    -1,    22,    23,    24,    25,    26,     7,     8,
       9,    10,    11,    12,    -1,    -1,    15,     7,     8,     9,
      10,    11,    12,    -1,    23,    24,    25,    26,    -1,    -1,
      -1,    -1,    22,    23,    24,    25,    26,     7,     8,     9,
      10,    11,    12,    -1,    -1,    15,     7,     8,     9,    10,
      11,    12,    -1,    23,    24,    25,    26,    -1,    -1,    -1,
      -1,    -1,    23,    24,    25,    26,     7,     8,     9,    10,
...
{
       0,     3,     4,     5,     6,    14,    27,    29,    30,    31,
      33,    34,    35,    37,    38,    40,    41,    42,    43,    46,
      47,    48,    43,    43,    14,    43,    14,     0,    35,    22,
      13,    14,    40,     7,     8,     9,    10,    11,    12,    22,
      23,    24,    25,    26,    45,    15,    18,    36,    43,    22,
      43,    43,    43,    44,    13,    14,    43,    43,    43,    43,
      43,    19,    34,    28,    22,    15,    15,    20,    43,    37,
      39,    41,    19,    36,    43,    36,    43,    15,    20,    40,
      22,    36,    37,    43,    15,    36
};
...
#line 87 "grammar.y" /* yacc.c:1646  */
    { 
                (yyval.stmt) = new NFunctionDeclaration(*(yyvsp[-5].ident), *(yyvsp[-4].ident), *(yyvsp[-2].varvec), (yyvsp[0].block)); 
            }
...
#line 93 "grammar.y" /* yacc.c:1646  */
    { (yyval.varvec) = new VariableList(); (yyval.varvec)->push_back((NVariableDeclaration*) (yyvsp[0].stmt)); }
#line 1412 "grammar.tab.c" /* yacc.c:1646  */
    break;

  case 19:
#line 94 "grammar.y" /* yacc.c:1646  */
    { (yyvsp[-2].varvec)->push_back((NVariableDeclaration*) (yyvsp[0].stmt)); }
...
#line 100 "grammar.y" /* yacc.c:1646  */
    { (yyval.ident) = new NIdentifier(*(yyvsp[0].string)); (yyval.ident)->isType = true;}
...
#line 133 "grammar.y" /* yacc.c:1906  */
